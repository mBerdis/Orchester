...
public class main
{
    ...
    //    bw.write(matej.saveData()+"\n");
        ...
        while ((line=br.readLine())!=null)
        {
            ...
            switch (splitLine[0])
            {
                case "n": nastroj = new Nastroj(splitLine[1], Double.parseDouble(splitLine[2]), splitLine[3], Integer.parseInt(splitLine[4]));
                            break;
                case "s": nastroj = new StrunovyNastroj(splitLine[1], Double.parseDouble(splitLine[2]), splitLine[3], Integer.parseInt(splitLine[4]),
                                                        Integer.parseInt(splitLine[5]),splitLine[6]);
                            break;
                case "S": nastroj = new SlacikovyNastroj(splitLine[1], Double.parseDouble(splitLine[2]), splitLine[3], Integer.parseInt(splitLine[4]),
                                                        Integer.parseInt(splitLine[5]),splitLine[6],splitLine[6]);
                            break;
                case "r": nastroj = new RytmickyNastroj(splitLine[1], Double.parseDouble(splitLine[2]), splitLine[3], Integer.parseInt(splitLine[4]),
                                                        Integer.parseInt(splitLine[5]));
                            break;
                case "k": nastroj = new KlavesovyNastroj(splitLine[1], Double.parseDouble(splitLine[2]), splitLine[3], Integer.parseInt(splitLine[4]),Integer.parseInt(splitLine[5]));
                            break;
                case "d": nastroj = new DychovyNastroj(splitLine[1], Double.parseDouble(splitLine[2]), splitLine[3], Integer.parseInt(splitLine[4]),
                                                        Integer.parseInt(splitLine[5]),splitLine[6]);
